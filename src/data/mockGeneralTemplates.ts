...
export const templateCards: TemplateCard[] = [
  ...
  { id: "t2", categoryId: "optimize", title: "续写", description: "承接现有内容，延续创作", iconColor: "bg-gradient-to-br from-literary-primary to-[#96724e]", iconEmoji: "📖" },
  ...
  { id: "t27", categoryId: "optimize", title: "检索成文", description: "多源调研整合，深度输出", iconColor: "bg-gradient-to-br from-literary-primary to-[#96724e]", iconEmoji: "🔎" },
  // 工作提效
  ...
  { id: "t10", categoryId: "work", title: "邮件沟通", description: "生成得体邮件，快速沟通", iconColor: "bg-gradient-to-br from-literary-primary to-[#96724e]", iconEmoji: "✉️" },
  ...
  { id: "t15", categoryId: "academic", title: "作文", description: "精准审题立意，生成高分范文", iconColor: "bg-gradient-to-br from-[#96724e] to-literary-primary", iconEmoji: "📄" },
