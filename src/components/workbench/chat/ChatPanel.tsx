        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 max-w-md w-full mx-4">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="group flex-1 bg-white rounded-xl border-2 border-literary-primary ring-2 ring-[#e8ddd0] p-4 text-left shadow-sm hover:shadow-md transition-all duration-200"
            >
              <div className="w-8 h-8 rounded-lg bg-literary-primary-light flex items-center justify-center mb-2.5">
                <MessageSquare className="w-4 h-4 text-literary-primary" />
              </div>
            ...
            <button
              ...
              className="group flex-1 bg-white rounded-xl border border-gray-200 p-4 text-left hover:border-[#c4aa8e] hover:shadow-md transition-all duration-200"
            >
              <div className="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center mb-2.5 group-hover:bg-literary-primary-light transition">
                <ListChecks className="w-4 h-4 text-gray-600 group-hover:text-literary-primary transition" />
              </div>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5" ref={scrollRef}>
        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center select-none">
            <div className="w-14 h-14 rounded-full bg-gradient-to-br from-literary-primary to-[#96724e] flex items-center justify-center mb-4 shadow-lg shadow-[#d4c4b0]/50">
            ...
            return (
              <div key={msg.id} className="space-y-3">
                <div className="flex items-center gap-2 mb-1">
                  <div className="w-6 h-6 rounded-full bg-gradient-to-br from-literary-primary to-[#96724e] flex items-center justify-center">
                      ...
                      <div key={i}>
                        <button
                          ...
                          className={`w-full text-left p-3.5 rounded-xl border-2 transition-all duration-200 ${
                            isSelected
                              ? "border-literary-primary bg-literary-primary-light shadow-sm"
                              : isOther
                              ? "border-transparent bg-gray-50 opacity-40"
                              : "border-gray-100 bg-white hover:border-[#d4c4b0] hover:shadow-sm cursor-pointer"
                          }`}
                        >
                          <div className="flex items-start gap-2.5">
                            <span
                              className={`w-5 h-5 rounded-full flex items-center justify-center text-xs font-medium shrink-0 mt-0.5 ${
                                isSelected
                                  ? "bg-literary-primary-light0 text-white"
                      ...
                      <div className="mt-2.5 space-y-2">
                        <div className="flex items-center gap-2.5">
                          <button
                            ...
                            className="flex-1 px-4 py-2.5 text-gray-700 text-sm rounded-xl border border-gray-200 hover:border-[#d4c4b0] hover:bg-literary-primary-light/50 transition"
                          >
                            跳过，直接生成
                          </button>
                          <button
                            ...
                            data-tip="重新生成本轮选项"
                            className="px-4 py-2.5 text-gray-700 text-sm rounded-xl border border-gray-200 hover:border-[#d4c4b0] hover:bg-literary-primary-light/50 transition"
                          >
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex-1 h-1 bg-gray-100 rounded-full overflow-hidden">
                            <div
                              className="h-full bg-literary-primary rounded-full transition-all duration-300"
          ...
          if (msg.sender === "model" && msg.type === "subtype-select") {
            return (
              <div key={msg.id} className="space-y-3">
                ...
                {!screenplaySubtype && (
                  <div className="pl-8 space-y-2">
                    <button
                      ...
                      className="w-full text-left p-3.5 rounded-xl border-2 border-gray-100 bg-white hover:border-[#d4c4b0] hover:shadow-sm cursor-pointer transition-all duration-200"
                    >
                      <div className="flex items-start gap-2.5">
                ...
                {screenplaySubtype && (
                  <div className="pl-8 space-y-2">
                    <div className="w-full text-left p-3.5 rounded-xl border-2 border-literary-primary bg-literary-primary-light shadow-sm">
                      <div className="flex items-start gap-2.5">
                        <span className="w-5 h-5 rounded-full flex items-center justify-center text-xs font-medium shrink-0 mt-0.5 bg-literary-primary-light0 text-white">
            ...
            return (
              <div key={msg.id} className="space-y-3">
                ...
                {!selectedScene ? (
                  <div className="pl-8 grid grid-cols-3 gap-2">
                    {scenes.map((s) => (
                      <button
                        ...
                        className="p-3 rounded-xl border-2 border-gray-100 bg-white hover:border-[#d4c4b0] hover:shadow-sm cursor-pointer transition-all text-center"
                      >
                  ...
                  <div className="pl-8">
                    <div className="inline-block px-4 py-2 rounded-xl border-2 border-literary-primary bg-literary-primary-light text-sm font-medium text-literary-primary">
              ...
              <div key={msg.id} className="space-y-3">
                ...
                <div className="pl-8 space-y-3">
                  {msg.scenarios.map((scenario, si) => (
                    <div
                      key={si}
                      className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden cursor-pointer hover:border-[#d4c4b0] transition"
                      onClick={() => {
                        setCreationStage(2);
                      ...
                      >
                        <div className="flex items-start gap-2.5">
                          <span className={`w-5 h-5 rounded-full flex items-center justify-center text-xs font-medium shrink-0 mt-0.5 ${
                            isSelected ? "bg-literary-primary-light0 text-white" : "bg-gray-100 text-gray-400"
                          }`}>{di + 1}</span>
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-literary-primary mt-1.5 italic">钩子：{dir.hook}</p>
                          </div>
                        </div>
                      </button>
                    );
                            ...
                            <tbody>
                              {ls.phases.map((p, pi) => (
                                <tr key={pi} className="border-b border-gray-50 last:border-0 align-top">
                                  ...
                                  <td className="py-1.5 pr-2 text-literary-primary text-[10px] leading-relaxed">{p.interaction}</td>
                    ...
                    <div className="px-4 py-2 border-t border-gray-50">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {note.tags.map((tag, ti) => (
                          <span key={ti} className="text-[10px] px-2 py-0.5 rounded-full bg-literary-primary-light text-literary-primary">{tag}</span>
                        ))}
                      </div>
                    </div>
          ...
          if (msg.sender === "user" && msg.type === "card-selection") {
            return (
              <div key={msg.id} className="flex justify-end">
                <div className="bg-literary-primary text-white rounded-2xl rounded-tr-sm px-4 py-3 max-w-[85%] shadow-sm">
          ...
          if (msg.sender === "model" && msg.type === "settings-card") {
            return (
              <div key={msg.id} className="space-y-3">
                ...
                <div className="pl-8">
                  <div
                    className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden relative cursor-pointer hover:border-[#d4c4b0] transition"
                    onClick={() => {
                      setCreationStage(1);
                                ...
                                <div key={item.label} className="flex items-start gap-2">
                                  ...
                                  <div className="flex flex-wrap gap-1">
                                    {item.value.split(" · ").map((tag) => (
                                      <span
                                        key={tag}
                                        className="px-2 py-0.5 bg-literary-primary-light text-literary-primary text-xs rounded-full"
                                      >
                                        {tag}
                                      </span>
                                    ))}
                      ...
                      <div className="px-4 py-3">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                            {msg.data.scenes.map((s) => (
                              <span key={s.name} className="px-2.5 py-1 bg-literary-primary-light text-literary-primary text-xs rounded-full">
                                {s.name}
                              </span>
                            ))}
                          </div>
                  ...
                  >
                    <div className="max-h-[200px] overflow-hidden">
                      ...
                      <div className="px-4 py-3">
                        ...
                        <p className="text-sm font-medium text-literary-primary">{msg.data.femaleLead.name}</p>
                      ...
                      <div className="px-4 py-3">
                        ...
                        <p className="text-sm font-medium text-literary-primary">{msg.data.maleLead.name}</p>
                      ...
                      <div className="px-4 py-3">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                            {msg.data.supporting.map((c) => (
                              <span key={c.name} className="px-2.5 py-1 bg-literary-primary-light text-literary-primary text-xs rounded-full">
                                {c.name}
                              </span>
                            ))}
                          </div>
