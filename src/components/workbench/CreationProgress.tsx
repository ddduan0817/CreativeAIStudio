          ...
          <div key={stage.id} className={`flex flex-col items-center ${i > 0 ? "flex-1" : ""}`}>
            ...
            {i > 0 && (
              <div className="w-px flex-1 relative">
                ...
                <div
                  className="absolute top-0 left-0 w-full bg-literary-primary transition-all duration-700 ease-out"
            ...
            <div className="flex flex-col items-center flex-shrink-0">
              <div
                className={`w-2 h-2 rounded-full transition-all duration-500 ${
                  isCompleted
                    ? "bg-literary-primary shadow-[0_0_6px_rgba(176,137,104,0.5)]"
                    : isCurrent
                    ? "bg-literary-primary shadow-[0_0_8px_rgba(176,137,104,0.4)] scale-125"
                    : "bg-gray-200"
                }`}
              />
              <span
