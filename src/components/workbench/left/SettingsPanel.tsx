    ...
    <div className="p-4 space-y-4">
      ...
      <div className="pb-3 border-b border-gray-100">
        ...
        <button
          ...
          className="w-full border border-dashed border-gray-200 rounded-lg py-2.5 text-xs text-gray-400 hover:border-[#c4aa8e] hover:text-literary-primary hover:bg-literary-primary-light/30 transition flex items-center justify-center gap-1.5"
        >
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs rounded-lg border transition ${
                      value === opt
                        ...
                        : "border-gray-200 text-gray-500 hover:border-[#d4c4b0] hover:text-literary-primary"
                    }`}
                  >
                    {opt}
                  </button>
