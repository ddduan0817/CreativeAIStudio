                  ...
                  {isSelectingType ? (
                    ...
                    <div>
                      {(() => {
                        ...
                        return current ? (
                          <div>
                            <div className="flex items-center gap-2 px-3 py-2 bg-literary-primary-light rounded-lg">
                              <div className="flex-1">
                                <span className="block text-sm font-medium text-literary-primary">{current.label}</span>
                                <span className="text-[10px] text-gray-400">{current.desc}</span>
                              </div>
                              <button
                                onClick={() => setIsSelectingType(true)}
                                className="text-xs text-literary-primary hover:text-literary-primary px-2 py-1 rounded hover:bg-[#ebe0d2] transition"
                              >
                                更换
                              </button>
                            </div>
