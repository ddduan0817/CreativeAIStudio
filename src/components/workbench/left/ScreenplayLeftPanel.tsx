          ...
          <div className="p-4 space-y-4">
            ...
            <div>
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-3 py-2.5 border border-dashed border-gray-200 rounded-lg text-sm text-gray-500 hover:border-[#c4aa8e] hover:text-literary-primary hover:bg-literary-primary-light/30 transition"
              >
...
【核心卖点】一句话提炼最抓人的卖点...`}
                  className={cn(
                    "w-full h-[180px] text-sm border rounded-lg p-3 pb-10 resize-none focus:outline-none focus:border-literary-primary focus:ring-2 focus:ring-[#e8ddd0] placeholder:text-gray-300 leading-relaxed",
                ...
                <div className="absolute bottom-3 right-3 flex items-center gap-0.5 bg-white rounded-md shadow-sm border border-gray-100">
                  <button
                    ...
                    className="p-1 text-gray-300 hover:text-literary-primary hover:bg-literary-primary-light rounded transition disabled:opacity-50"
                    title="AI 生成设定"
                  >
                ...
                {[
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      sceneType === item.id
                        ? "border-[#c4aa8e] bg-literary-primary-light text-literary-primary"
            ...
            <div>
              <button
                ...
                className={cn(
                  ...
                  getWritingSelectedCount() > 0
                    ? "border-[#d4c4b0] bg-literary-primary-light/50 text-literary-primary"
                    : "border-gray-200 text-gray-500 hover:border-gray-300"
                )}
              >
                <div className="flex items-center gap-2">
                  ...
                  <span>剧集规格</span>
                  {getWritingSelectedCount() > 0 && (
                    <span className="text-xs text-literary-primary">
              ...
              {getWritingSelectedCount() > 0 && expandedSection !== "writing" && (
                <div className="mt-2 flex flex-wrap gap-1.5">
                  {episodeRange && (
                    <span className="px-2 py-0.5 bg-literary-primary-light text-literary-primary text-xs rounded-full">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg border border-dashed border-gray-200 text-sm text-gray-500 hover:border-[#c4aa8e] hover:text-literary-primary hover:bg-literary-primary-light/30 transition"
              >
        ...
        <div className="p-4 border-t border-gray-100">
          <button
            ...
            className={cn(
              ...
              isGenerated
                ? "text-white bg-literary-primary hover:bg-literary-primary-hover"
                ...
                <div>
                  ...
                  {episodeRange === "custom" && (
                    <input
                      ...
                      placeholder="输入集数"
                      className="mt-2 w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-[#c4aa8e] bg-white"
                    />
                  )}
                </div>
