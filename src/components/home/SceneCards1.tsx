    ...
    <div className="grid grid-cols-3 gap-4">
      {scenes.map((scene) => (
        <button
          ...
          className="rounded-2xl overflow-hidden bg-white border border-cream-border-warm hover:shadow-warm-md hover:-translate-y-0.5 transition-all duration-200 text-left group"
        >
          {/* Illustration area */}
          <div
