  ...
  return (
    <div className="px-4 pb-4 space-y-2">
      ...
      <button
        ...
        className="w-full rounded-xl bg-gradient-to-r from-literary-primary-light to-[#f0e8de] border border-[#e8ddd0] hover:border-[#d4c4b0] p-4 text-left transition hover:shadow-sm group"
      >
        <div className="flex items-center gap-2">
          <ShieldCheck className="w-5 h-5 text-literary-primary" />
          <span className="text-base font-bold bg-gradient-to-r from-literary-primary to-[#96724e] bg-clip-text text-transparent">
            一致性校对
          </span>
        </div>
    ...
    <div className="px-4 pb-4 space-y-3">
          ...
          {categories.map((cat) => (
            <button
              ...
              className={cn(
                ...
                category === cat.id
                  ? "bg-literary-primary-light border-[#d4c4b0] text-literary-primary"
      ...
      {!selectedTip ? (
        <div className="space-y-2">
          {tips.map((tip, i) => (
            <button
              ...
              className="w-full text-left p-3 rounded-lg border border-gray-100 hover:border-[#d4c4b0] hover:bg-literary-primary-light/30 transition"
            >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 py-2 text-xs text-gray-400 hover:text-literary-primary transition"
          >
        ...
        <div className="space-y-2">
          ...
          <div className="rounded-lg bg-literary-primary-light/50 border border-[#e8ddd0] overflow-hidden">
            <div className="px-3 pt-2.5 pb-1 flex items-center justify-between">
              <p className="text-xs font-medium text-literary-primary">
                {selectedTip.title}
              </p>
              <span className="text-[10px] text-literary-primary px-1.5 py-0.5 bg-[#ebe0d2] rounded">梗概</span>
            </div>
            {generating ? (
          ...
          {(phase === "expanding" || phase === "editing" || phase === "confirmed" || phase === "applied") && (
            <div className="rounded-lg bg-green-50/50 border border-green-100 overflow-hidden">
              <div className="px-3 pt-2.5 pb-1 flex items-center justify-between">
                ...
                {phase === "editing" && (
                  <span className="text-[10px] text-literary-primary px-1.5 py-0.5 bg-[#ebe0d2] rounded">可编辑</span>
                )}
            ...
            <div className="space-y-2">
              ...
              {phase === "outline" && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-white bg-literary-primary rounded-lg hover:bg-literary-primary-hover transition"
                >
              ...
              {phase === "editing" && (
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-white bg-literary-primary rounded-lg hover:bg-literary-primary-hover transition"
                  >
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="text-xs text-gray-500 hover:text-literary-primary flex items-center gap-1"
                >
                  <RefreshCw className="w-3 h-3" /> 换一换
                </button>
                <button
        ...
        <>
          ...
          {data.issues.map((issue, i) => (
            ...
            >
              ...
              <p className="text-xs text-literary-primary">💡 {issue.suggestion}</p>
            </div>
          ))}
        </>
      )}
...
function ConsistencyView({ onBack }: { onBack: () => void }) {
  ...
  const severityConfig = {
    ...
    info: { icon: Info, color: "text-literary-primary", bg: "bg-literary-primary-light" },
  ...
  return (
    <div className="px-4 pb-4 space-y-3">
      ...
      <div className="flex items-center gap-2 mb-1">
        <ShieldCheck className="w-4 h-4 text-literary-primary" />
