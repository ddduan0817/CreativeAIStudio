      ...
      <button
        ...
        className={`px-2 py-1 text-xs rounded transition ${
          layoutMode === "ai-assist"
            ? "bg-[#ebe0d2] text-literary-primary"
...
function HistoryPanel({
  ...
  const getActionLabel = (action: HistoryItem["action"]) => {
    const labels: Record<HistoryItem["action"], { text: string; icon: typeof FileText; color: string }> = {
      ...
      ai_polish: { text: "AI润色", icon: Sparkles, color: "text-literary-primary" },
      ai_condense: { text: "AI缩写", icon: Sparkles, color: "text-green-500" },
      ai_atmosphere: { text: "AI氛围增强", icon: Sparkles, color: "text-orange-500" },
      manual_save: { text: "手动保存", icon: Save, color: "text-literary-primary" },
    };
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2.5 border-b border-gray-50 hover:bg-gray-50 transition ${
                        selectedId === item.id ? "bg-literary-primary-light" : ""
                      }`}
                    >
                ...
                <div className="p-4 border-b border-gray-100 flex-shrink-0">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-literary-primary rounded-lg hover:bg-literary-primary-hover transition"
                    >
