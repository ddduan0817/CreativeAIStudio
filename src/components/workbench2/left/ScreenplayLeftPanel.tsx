            ...
            <button
              ...
              className={cn(
                ...
                activeCategory === cat.id
                  ? "bg-literary-primary-light ring-1 ring-[#d4c4b0]"
                  : "hover:bg-gray-50"
              )}
            >
              <div className="w-8 h-8 rounded-lg bg-literary-primary-light flex items-center justify-center flex-shrink-0">
                <Icon className="w-4 h-4 text-literary-primary" />
              </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-3 py-3 border-b border-gray-50 flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded bg-literary-primary-light flex items-center justify-center flex-shrink-0">
              <Icon className="w-3.5 h-3.5 text-literary-primary" />
            </div>
      ...
      {sections.map((section) => (
        <div key={section.id} className="border-b border-gray-50 last:border-b-0">
          ...
          <button
            ...
            className={cn(
              ...
              expandedSection === section.id
                ? "text-literary-primary font-medium bg-literary-primary-light/50"
                : "text-gray-600"
            )}
          >
            ...
            {section.id === "scenes" && expandedSection !== "scenes" && (
              <span
                ...
                className="p-1 text-gray-400 hover:text-literary-primary rounded hover:bg-gray-100 transition"
              >
          ...
          >
            {/* 剧本设定 */}
            {section.id === "settings" && (
              <div className="ml-2 border-l-2 border-[#e8ddd0]">
              ...
              <div>
                <div className="flex items-center justify-end px-4 py-1">
                  <button
                    ...
                    className="flex items-center gap-1 text-xs text-literary-primary hover:text-literary-primary px-2 py-1 rounded hover:bg-literary-primary-light transition"
                  >
    ...
    <div className="px-4 pb-4 space-y-4">
      ...
      <div>
        ...
        <button
          ...
          className="w-full border border-dashed border-gray-200 rounded-lg py-3 text-xs text-gray-400 hover:border-[#c4aa8e] hover:text-literary-primary hover:bg-literary-primary-light/30 transition flex items-center justify-center gap-1.5"
        >
            ...
            <button
              ...
              className={cn(
                ...
                outlineStructure === s.id
                  ? "border-[#c4aa8e] bg-literary-primary-light text-literary-primary font-medium"
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full text-xs border border-gray-200 rounded-lg p-2.5 resize-none focus:outline-none focus:border-[#c4aa8e] focus:ring-1 focus:ring-[#e8ddd0] placeholder:text-gray-300"
          rows={3}
        />
      </div>
          ...
          {[
            ...
            <div key={node.key}>
              ...
              <input
                ...
                className="w-full text-xs border border-gray-200 rounded-lg px-2.5 py-2 focus:outline-none focus:border-[#c4aa8e] focus:ring-1 focus:ring-[#e8ddd0] placeholder:text-gray-300"
              />
            </div>
          ))}
        </div>
      ...
      <div>
        <button
          onClick={onGenerate}
          disabled={generating}
          className="w-full flex items-center justify-center gap-1.5 py-2 text-xs bg-literary-primary text-white rounded-lg hover:bg-literary-primary-hover transition disabled:opacity-50"
        >
          {generating ? (
