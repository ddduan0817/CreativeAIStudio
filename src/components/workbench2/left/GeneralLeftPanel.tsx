  ...
  return (
    <div className="space-y-4">
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedSubTemplateId === sub.id
                    ...
                    : "border-gray-200 text-gray-500 hover:border-[#d4c4b0] hover:bg-gray-50"
                )}
              >
                {sub.title}
              </button>
        ...
        <div key={field.key}>
          ...
          {field.type === "input" && (
            <input
              ...
              className="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-[#c4aa8e] focus:ring-1 focus:ring-[#e8ddd0] placeholder:text-gray-300"
            />
          )}
          ...
          {field.type === "textarea" && (
            <textarea
              ...
              placeholder={field.placeholder}
              rows={field.rows || 3}
              className="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 resize-none focus:outline-none focus:border-[#c4aa8e] focus:ring-1 focus:ring-[#e8ddd0] placeholder:text-gray-300"
            />
          )}
      ...
      <button
        ...
        disabled={generating}
        className="w-full flex items-center justify-center gap-2 py-2.5 bg-literary-primary text-white text-sm font-medium rounded-lg hover:bg-literary-primary-hover transition disabled:opacity-50"
      >
        {generating ? (
          <>
