  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <button
        ...
        disabled={generating}
        className="w-full flex items-center justify-center gap-2 py-2.5 text-sm font-medium text-literary-primary bg-literary-primary-light rounded-lg hover:bg-[#ebe0d2] transition disabled:opacity-50"
      >
        {generating ? (
