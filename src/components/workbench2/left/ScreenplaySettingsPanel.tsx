            ...
            {field.options?.map((opt) => (
              <button
                ...
                className={cn(
                  ...
                  value === opt
                    ? "border-literary-primary bg-literary-primary-light text-literary-primary font-medium"
        ...
        return (
          <div className="space-y-2">
            <input
              ...
              className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[#b08968]"
            />
            ...
            {value && <p className="text-xs text-literary-primary font-medium">当前：{value}</p>}
          </div>
        );
        ...
        return (
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-2.5 py-1.5 text-xs bg-literary-primary text-white rounded-lg hover:bg-literary-primary-hover transition"
            >
              生成
            </button>
          </div>
        ...
        return (
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 text-xs border border-gray-200 rounded-lg px-2.5 py-2 focus:outline-none focus:border-[#c4aa8e] focus:ring-1 focus:ring-[#e8ddd0] placeholder:text-gray-300"
            />
            <button
              onClick={() => handleGenerate(field.key)}
              disabled={generating === field.key}
              className="p-1.5 text-gray-400 hover:text-literary-primary rounded disabled:opacity-50"
              title="AI 生成"
            >
        ...
        return (
          <div className="space-y-1.5">
            ...
            <button
              onClick={() => handleGenerate(field.key)}
              disabled={generating === field.key}
              className="flex items-center gap-1 text-xs text-literary-primary hover:text-literary-primary disabled:opacity-50"
            >
              {generating === field.key ? (
