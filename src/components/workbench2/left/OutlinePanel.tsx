    ...
    <div className="h-full flex flex-col">
      <div className="flex items-center justify-between p-4 border-b border-gray-50">
        ...
        <button
          ...
          disabled={generating}
          className="flex items-center gap-1 px-3 py-1.5 text-xs bg-literary-primary text-white rounded-lg hover:bg-literary-primary-hover transition disabled:opacity-50"
        >
          {generating ? (
      ...
      <div className="p-3 border-t border-gray-50">
        <button
          ...
          className="w-full py-2 text-sm text-literary-primary hover:bg-literary-primary-light rounded-lg transition"
        >
          返回编辑器
        </button>
      </div>
