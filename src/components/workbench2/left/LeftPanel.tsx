      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-0.5 text-xs text-literary-primary hover:text-literary-primary hover:bg-literary-primary-light rounded transition disabled:opacity-50"
          >
