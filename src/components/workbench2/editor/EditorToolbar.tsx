  ...
  const handleContinue = () => {
    ...
    simulateAIStream(mockData.continuation, (current, done) => {
      ...
      editor.commands.setContent(
        cleanContent +
          '<div class="border-l-2 border-[#c4aa8e] pl-3 mt-4">' +
          paragraphs +
  ...
  return (
    <div className="flex items-center gap-0.5 px-4 py-2 border-b border-gray-100 flex-shrink-0 flex-wrap">
      ...
      <button
        ...
        disabled={continuing}
        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-literary-primary bg-literary-primary-light rounded-lg hover:bg-[#ebe0d2] transition disabled:opacity-50"
