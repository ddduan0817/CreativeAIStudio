    ...
    <div className="h-full flex flex-col overflow-hidden relative">
            ...
            >
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-1.5 rounded hover:bg-literary-primary-light text-literary-primary text-xs font-medium"
                >
                ...
                {showAIMenu && (
                  <div className="absolute left-0 top-full mt-1 bg-white rounded-lg shadow-xl border py-1 z-30 w-32">
                    ...
                    <button
                      ...
                      className="w-full text-left px-3 py-2 text-xs hover:bg-literary-primary-light text-literary-primary font-medium"
                    >
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 border-t border-gray-100 bg-gray-50/50 flex-shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-1.5 text-xs font-medium text-white bg-literary-primary rounded-lg hover:bg-literary-primary-hover transition"
        >
